                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                if ppp in ['1','01']:
                                        ...
                                        plist.append('firstlast12$')
                                        plist.append('firstlast13@')
                                        plist.append('firstlast13#')
                                        plist.append('firstlast13$')
                                        plist.append('firstlast113#')
                                        plist.append('firstlast112@')
                                        plist.append('first555last')
                                        plist.append('first566last')
                                        plist.append('first765last')
                                        plist.append('first543last')
                                        plist.append('first1111last')
